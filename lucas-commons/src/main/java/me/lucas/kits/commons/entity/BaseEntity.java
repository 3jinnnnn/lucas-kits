 ...
 */
package me.lucas.kits.commons.entity;
...
import me.lucas.kits.commons.exception.EntityException;
import me.lucas.kits.commons.format.ClassCast;
...
public abstract class BaseEntity implements Cloneable, Serializable {
    ...
    private static final long serialVersionUID = -2687535885378413193L;

    private static final transient List<String> FILTER_FIELD_NAMES = Lists
            .newArrayList("names", "cls", "methods", "fields");
    ...
    public void setAttributeValue(final String fieldName, final Object value, final boolean isCase) {
        ...
        try {
            if (fields.containsKey(fieldName)) {
                final Field field = fields.get(fieldName);
                if ((!isCase && fieldName.toUpperCase().equals(field.getName().toUpperCase())) || (isCase && fieldName
     ...
     * @return 转换后的实体类集合
     */
    public static <T extends BaseEntity> List<T> mapToBeans(final List<Map<String, Object>> beanMaps,
