...
public abstract class Assert {
    ...
    public static void isInstanceOf(Class<?> type, Object obj, String message) {
        ...
        if (!type.isInstance(obj)) {
            throw new IllegalArgumentException((StringUtils.hasLength(message) ? message + ' ' : "") + "Object of class ["
    ...
    public static void notInList(Object target, Object[] sources) {
        notInList(target, sources, "[Assertion failed] - target is not in sources list");
    }

    public static void notInList(Object target, Object[] sources, String message) {
        if (!ObjectCompare.isInList(target, sources))
            throw new IllegalArgumentException(message);
    }
}
