 ...
 */
package me.lucas.kits.commons.format;
...
import me.lucas.kits.commons.utils.ObjectCompare;
...
public final class ClassCast {
    ...
    public static final Object cast(final String value, final String typeName) {
        ...
        try {
            ...
            throw new me.lucas.kits.commons.exception.ClassCastException(e.getMessage(), e);
