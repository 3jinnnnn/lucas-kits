...
public interface SortedSetRedisClient {
    ...
    <T> Map<T, Double> zrangeByScoreWithScores(String key, double min, double max, int offset, int count,
            TypeReference<T> type);

    <T> Map<T, Double> zrangeByScoreWithScores(String key, String min, String max, int offset, int count,
            TypeReference<T> type);
    ...
    <T> Map<T, Double> zrevrangeByScoreWithScores(String key, double max, double min, int offset, int count,
            TypeReference<T> type);
